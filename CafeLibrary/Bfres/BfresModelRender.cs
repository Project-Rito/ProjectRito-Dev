...
/*
        ...
        {
            GLL.Uniform1(GLL.GetUniformLocation(programID, "UseSkinning"), 1);
            ...
            for (int i = 0; i < skeleton.Bones.Count; i++)
            {
                ...
                GLL.UniformMatrix4(GLL.GetUniformLocation(programID, String.Format("bones[{0}]", i)), false, ref transform);
            }
        }
    }
}
