...
namespace CafeLibrary
{
    public class UKingNXRender : BfshaRenderer
    {
        ...
        public UKingNXRender(BfresRender render, BfresModelRender model) : base(render, model)
        {
        }

        public override void ReloadRenderState(BfresMeshRender mesh)
        {
            return;
            if (this.ShaderOptions["gsys_static_depth_shadow_only"] == "1")
                mesh.IsDepthShadow = true;
            if (this.ShaderOptions["gsys_pass"] == "seal")
                mesh.IsSealPass = true;
            if (this.ShaderOptions["gsys_cube_map_only"] == "1")
                mesh.IsCubeMap = true;
        }
        ...
        public override void ReloadProgram(BfresMeshRender mesh)
        {
            ...
            foreach (var op in this.ShaderOptions)
        ...
        static void InitTextures()
        {
            ...
            LightPPTexture = GLTexture2DArray.CreateConstantColorTexture(32, 32, 1, 0, 0, 0, 1);
