...
namespace Toolbox.Core.Imaging
{
 ...
 ImageLockMode.ReadWrite, PixelFormat.Format32bppArgb);
     ...
     ImageLockMode.ReadWrite, PixelFormat.Format32bppArgb);
        ...
        public static Bitmap CreateImageThumbnail(Bitmap image, int width, int height, bool removeAlpha = false)
        {
            int tw, th, tx, ty;
            ...
            if (removeAlpha)
                image = ReplaceTransparency(image, Color.Black);
        ...
        public static Bitmap ReplaceTransparency(Bitmap bitmap, Color background)
        {
            ...
            var result = new Bitmap(bitmap.Size.Width, bitmap.Size.Height, System.Drawing.Imaging.PixelFormat.Format32bppArgb);
