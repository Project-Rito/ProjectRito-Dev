...
namespace Toolbox.Core
{
    public class Decode_Gamecube
    {
        ...
        public static PaletteFormat ToGenericPaletteFormat(PaletteFormats Format)
        {
            switch (Format)
            {
                case PaletteFormats.IA8: return PaletteFormat.IA8;
                case PaletteFormats.RGB565: return PaletteFormat.RGB565;
                case PaletteFormats.RGB5A3: return PaletteFormat.RGB5A3;
                default:
