    ...
    public class DDS : STGenericTexture, IFileFormat, IExportableTexture
    {
        ...
        public void SetFlags(TexFormat format, bool isDX10, bool isCubemap)
        {
            ...
            if (isDX10)
            {
                ...
                if (isCubemap)
                {
                    Dx10Header.ArrayCount = ArrayCount;
            ...
            if (format == TexFormat.RG8_UNORM)
                PfHeader.RgbBitCount = 24;
           ...
           PfHeader.Flags = (uint)(DDPF.RGB | DDPF.ALPHAPIXELS);
            ...
            switch (format)
            {
                ...
                case TexFormat.BC7_SRGB:
                    ...
                    if (dxgiFormat == DXGI_FORMAT.DXGI_FORMAT_BC7_UNORM_SRGB)
                        Dx10Header.DxgiFormat = (uint)DXGI_FORMAT.DXGI_FORMAT_BC7_UNORM;
                    break;
            }
        }
        ...
        {
            if (FileInfo == null) FileInfo = new File_Info();
            ...
            using (var reader = new FileReader(stream))
            {
                ...
                Depth = Math.Max(1, MainHeader.Depth);
                ...
                if (IsDX10)
                    ArrayCount = Dx10Header.ArrayCount;

                if (((DDSCAPS2)PfHeader.Caps2).HasFlag(DDSCAPS2.VOLUME))
                    SurfaceType = STSurfaceType.Texture3D;
        ...
        public override byte[] GetImageData(int ArrayLevel = 0, int MipLevel = 0, int DepthLevel = 0) {
            ...
            var surfaces = DDSHelper.GetArrayFaces(this);
