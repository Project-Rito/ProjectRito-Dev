...
namespace Toolbox.Core.Collada
{
    public class DAE
    {
        ...
        public class ImportSettings
        {
            ...
            public bool ApplyMatrices = true;
        ...
        public static void Export(string FileName, ExportSettings settings, STGenericModel model, List<STGenericTexture> Textures, STSkeleton skeleton = null)
        {
            Export(FileName, settings, model.Meshes, model.GetMaterials(), Textures, model.Skeleton);
        }

        public static void ExportAnimation(string FileName, STAnimation animation, ExportSettings settings)
        {
            using (ColladaWriter writer = new ColladaWriter(FileName, settings))
            {
                writer.WriteAsset();
                var daeAnim = new Animation();
        ...
        public static void Export(string FileName, ExportSettings settings,
            ...
            List<STGenericTexture> Textures, STSkeleton skeleton = null)
        {
            if (Materials == null)
            ...
            using (ColladaWriter writer = new ColladaWriter(FileName, settings))
            {
                ...
                {
                    int[] IndexTable = null;
                    if (skeleton.RemapTable != null)
                        IndexTable = skeleton.RemapTable.ToArray();
